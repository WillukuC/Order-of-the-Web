...
Here's a blank template to get started. To avoid retyping too much info, do a search and replace with your text editor for the following: `WillukuC`, `Order-of-the-Web`, `twitter_handle`, `linkedin_username`, `email_client`, `email`, `Order of the Web`, `project_description`, `project_license`
...
2. Clone the repo
   ```sh
   git clone https://github.com/WillukuC/Order-of-the-Web.git
   ```
...
5. Change git remote url to avoid accidental pushes to base project
   ```sh
   git remote set-url origin WillukuC/Order-of-the-Web
